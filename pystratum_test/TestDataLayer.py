...
class TestDataLayer(StaticDataLayer):
    ...
    def tst_magic_constant01():
        return StaticDataLayer.execute_sp_singleton1('exec [dbo].[tst_magic_constant01]')

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_magic_constant02():
        return StaticDataLayer.execute_sp_singleton1('exec [dbo].[tst_magic_constant02]')

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_magic_constant03():
        return StaticDataLayer.execute_sp_singleton1('exec [dbo].[tst_magic_constant03]')

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_magic_constant04():
        return StaticDataLayer.execute_sp_singleton1('exec [dbo].[tst_magic_constant04]')
    ...
    def tst_parameter_types02(tst_bigint, tst_int, tst_smallint, tst_tinyint, tst_bit, tst_money, tst_smallmoney, tst_decimal, tst_numeric, tst_float, tst_real, tst_date, tst_datetime, tst_datetime2, tst_datetimeoffset, tst_smalldatetime, tst_time, tst_char, tst_varchar, tst_text, tst_nchar, tst_nvarchar, tst_ntext, tst_binary, tst_varbinary, tst_image, tst_xml):
        return StaticDataLayer.execute_sp_none('exec [dbo].[tst_parameter_types02] %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s', tst_bigint, tst_int, tst_smallint, tst_tinyint, tst_bit, tst_money, tst_smallmoney, tst_decimal, tst_numeric, tst_float, tst_real, tst_date, tst_datetime, tst_datetime2, tst_datetimeoffset, tst_smalldatetime, tst_time, tst_char, tst_varchar, tst_text, tst_nchar, tst_nvarchar, tst_ntext, tst_binary, tst_varbinary, tst_image, tst_xml)

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_function(p_a, p_b):
        return StaticDataLayer.execute_sp_singleton1('select [dbo].[tst_test_function](%s, %s)', p_a, p_b)

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_none0(p_tst_test, p_tst_label):
        return StaticDataLayer.execute_sp_none('exec [dbo].[tst_test_none0] %s, %s', p_tst_test, p_tst_label)

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_none1():
        return StaticDataLayer.execute_sp_none('exec [dbo].[tst_test_none1]')

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_row0(p_count):
        return StaticDataLayer.execute_sp_row0('exec [dbo].[tst_test_row0] %s', p_count)

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_row1(p_count):
        return StaticDataLayer.execute_sp_row1('exec [dbo].[tst_test_row1] %s', p_count)

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_rows(p_count):
        return StaticDataLayer.execute_sp_rows('exec [dbo].[tst_test_rows] %s', p_count)

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_rows_with_index1(p_count):
        ret = {}
        rows = StaticDataLayer.execute_sp_rows('exec [dbo].[tst_test_rows_with_index1] %s', p_count)
        for row in rows:
    ...
    def tst_test_rows_with_key1(p_count):
        ret = {}
        rows = StaticDataLayer.execute_sp_rows('exec [dbo].[tst_test_rows_with_key1] %s', p_count)
        for row in rows:
            if row['tst_c01'] in ret:
                if row['tst_c02'] in ret[row['tst_c01']]:
    ...
    def tst_test_singleton0(p_count):
        return StaticDataLayer.execute_sp_singleton0('exec [dbo].[tst_test_singleton0] %s', p_count)

    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def tst_test_singleton1(p_count):
        return StaticDataLayer.execute_sp_singleton1('exec [dbo].[tst_test_singleton1] %s', p_count)
