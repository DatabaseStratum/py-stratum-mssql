...
class TestDataLayer(MsSqlDataLayer):
    ...
    # ------------------------------------------------------------------------------------------------------------------
    def tst_parameter_types02(self, p_tst_bigint: Optional[int], p_tst_int: Optional[int], p_tst_smallint: Optional[int], p_tst_tinyint: Optional[int], p_tst_bit: Optional[int], p_tst_money: Optional[str], p_tst_smallmoney: Optional[str], p_tst_decimal: Optional[float], p_tst_numeric: Optional[float], p_tst_float: Optional[float], p_tst_real: Optional[float], p_tst_date: Optional[str], p_tst_datetime: Optional[str], p_tst_datetime2: Optional[str], p_tst_datetimeoffset: Optional[str], p_tst_smalldatetime: Optional[str], p_tst_time: Optional[str], p_tst_char: Optional[str], p_tst_varchar: Optional[str], p_tst_text: Optional[str], p_tst_nchar: Optional[str], p_tst_nvarchar: Optional[str], p_tst_ntext: Optional[str], p_tst_binary: Optional[bytes], p_tst_varbinary: Optional[bytes], p_tst_image: Optional[bytes], p_tst_xml: Optional[str]):
        return self.execute_sp_none('exec [dbo].[tst_parameter_types02] %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s', p_tst_bigint, p_tst_int, p_tst_smallint, p_tst_tinyint, p_tst_bit, p_tst_money, p_tst_smallmoney, p_tst_decimal, p_tst_numeric, p_tst_float, p_tst_real, p_tst_date, p_tst_datetime, p_tst_datetime2, p_tst_datetimeoffset, p_tst_smalldatetime, p_tst_time, p_tst_char, p_tst_varchar, p_tst_text, p_tst_nchar, p_tst_nvarchar, p_tst_ntext, p_tst_binary, p_tst_varbinary, p_tst_image, p_tst_xml)
